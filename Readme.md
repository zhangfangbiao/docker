![Docker Pulls](https://img.shields.io/docker/pulls/zhangfangbiao/scripts?style=for-the-badge)
### Usage
```diff
...
+ 2021-02-21更新 https://gitee.com/zhangfangbiao/scripts仓库被迫私有，老用户重新更新一下镜像：https://hub.docker.com/r/zhangfangbiao/scripts)(docker-compose.yml的REPO_URL记得修改)后续可同步更新jd_script仓库最新脚本
...
- 目录文件配置好之后在 `jd_scripts`目录执行。  
 ...
 `docker-compose pull` 更新镜像；多容器用户推荐使用`docker pull zhangfangbiao/scripts`；  
